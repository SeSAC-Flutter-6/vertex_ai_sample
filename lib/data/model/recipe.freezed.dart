...
abstract class $RecipeCopyWith<$Res> {
  ...
  @useResult
  $Res call({String title, List<String> procedures});
}
...
class _$RecipeImpl implements _Recipe {
  const _$RecipeImpl(
      {required this.title, required final List<String> procedures})
  ...
  @override
  String toString() {
    return 'Recipe(title: $title, procedures: $procedures)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, title, const DeepCollectionEquality().hash(_procedures));
...
abstract class _Recipe implements Recipe {
  const factory _Recipe(
      ...
      required final List<String> procedures}) = _$RecipeImpl;
